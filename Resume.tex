...
{\begin{itemize}
  \item During this time, I have been working on automotive diagnostics tools in one of the most reputable companies that make automotive diagnostics tools(Like a Diag device), which includes working on software and a little bit of hardware and network protocols.
